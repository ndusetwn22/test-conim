...
// // }
var hak_akses = (localStorage.getItem('account') == undefined || localStorage.getItem('account') == null) ? null:JSON.parse(localStorage.getItem('account')).role
...
super_admin = [
  ...
  },
  {
    ...
    // permissions: ["admin", "editor"],
    navLink: "/contact-us",
    filterBase: "/contact-us"
  },
  // {
  //   type: "groupHeader",
  //   groupTitle: "APPS EXAMPLE"
  // },
  // {
  //   id: "dashboard",
  //   title: "Dashboard",
...
spv_df = [
  ...
  {
    type: "groupHeader",
    groupTitle: "Suggestion System Spv"
  },
  {
    id: "spv-approval-ss",
    title: "Approval SS",
    ...
    // permissions: ["admin", "editor"],
    navLink: "/spv-approval-ss",
    filterBase: "/spv-approval-ss"
  },
  {
    id: "spv-list-ss",
    title: "List SS",
  ...
  },
  {
    ...
    // permissions: ["admin", "editor"],
    navLink: "/spv-rekap-ss",
    filterBase: "/spv-rekap-ss"
  },
  {
    type: "groupHeader",
    groupTitle: "Support"
...
officer_df = [
  ...
  {
    type: "groupHeader",
    groupTitle: "Suggestion System Officer"
  },
  {
    id: "officer-approval-ss",
    title: "Approval SS",
    type: "item",
    icon: <Icon.CheckCircle size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/officer-approval-ss",
    filterBase: "/officer-approval-ss"
  },
  {
    id: "officer-list-ss",
    title: "List SS",
    ...
    icon: <Icon.List size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/officer-list-ss",
    filterBase: "/officer-list-ss"
  },
  {
    id: "officer-rekap-ss",
    title: "Rekap SS",
    ...
    icon: <Icon.Archive size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/officer-rekap-ss",
    filterBase: "/officer-rekap-ss"
  },
  {
    id: "officer-dashboard-ss",
    title: "Dashboard",
    type: "item",
    icon: <Icon.Monitor size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/officer-dashboard-ss",
    filterBase: "/officer-dashboard-ss"
  },
  {
    id: "officer-dashboard-ss-dept",
    title: "Dashboard Dept",
    type: "item",
    icon: <Icon.Navigation size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/officer-dashboard-ss-dept",
    filterBase: "/officer-dashboard-ss-dept"
  },
  {
    type: "groupHeader",
    groupTitle: "Support"
...
fa_df = [
  ...
  {
    type: "groupHeader",
    groupTitle: "Suggestion System FA"
  },
  {
    id: "fa-approval-ss",
    title: "Approval SS",
    ...
    icon: <Icon.CheckCircle size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/fa-approval-ss",
    filterBase: "/fa-approval-ss"
  },
  {
    type: "groupHeader",
    groupTitle: "Support"
...
mstd_df = [
  ...
  {
    type: "groupHeader",
    groupTitle: "Suggestion System MSTD"
  },
  {
    id: "mstd-approval-ss",
    title: "Approval SS",
    ...
    icon: <Icon.CheckCircle size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/mstd-approval-ss",
    filterBase: "/mstd-approval-ss"
  },
  {
    id: "mstd-list-ss",
    title: "List SS",
    ...
    icon: <Icon.List size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/mstd-list-ss",
    filterBase: "/mstd-list-ss"
  },
  {
    id: "mstd-rekap-ss",
    title: "Rekap SS",
    ...
    icon: <Icon.Archive size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/mstd-rekap-ss",
    filterBase: "/mstd-rekap-ss"
  },
  {
    id: "mstd-dashboard-ss",
    title: "Dashboard",
    type: "item",
    icon: <Icon.Monitor size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/mstd-dashboard-ss",
    filterBase: "/mstd-dashboard-ss"
  },
  {
    id: "mstd-dashboard-ss-dept",
    title: "Dashboard Dept",
    type: "item",
    icon: <Icon.Navigation size={20} />,
    // permissions: ["admin", "editor"],
    navLink: "/mstd-dashboard-ss-dept",
    filterBase: "/mstd-dashboard-ss-dept"
  },
  {
    type: "groupHeader",
    groupTitle: "Support"
...
var navigationConfig =
      hak_akses === 'op_df' ? op_df:
      hak_akses === 'spv_df' ? spv_df:
      hak_akses === 'officer_df' ? officer_df:
      hak_akses === 'fa_df' ? fa_df:
      hak_akses === 'mstd_df' ? mstd_df:
      hak_akses === 'super_admin' ? super_admin:
      default_df
