...
// Operator
const OpSsPage = lazy(() => import("./views/ss/op-ss/OpSsPage"))

// Spv
const SpvApprovalSsPage = lazy(() => import("./views/ss/spv-approval-ss/SpvApprovalSSPage"))
const SpvRekapPage = lazy(() => import("./views/ss/spv-approval-ss/component-rekap/SpvRekapPage"))
const SpvListSs = lazy(() => import("./views/ss/spv-approval-ss/component-list/SpvListSsPage"))


// Officer
const OfficerApprovalSsPage = lazy(() => import("./views/ss/officer-approval-ss/OfficerApprovalSsPage"))
// const OfficerListSs = lazy(() => import("./views/ss/officer-approval-ss/component-list/OfficerListSs"))
const OfficerListSs = lazy(() => import("./views/ss/officer-approval-ss/component-list/OfficerListPage"))
const OfficerDashboardSs = lazy(() => import("./views/ss/officer-approval-ss/component/OfficerDashboardSs"))
const OfficerDashboardSsDept = lazy(() => import("./views/ss/officer-approval-ss/component/OfficerDashboardSsDept"))
const OfficerRekapPage = lazy(() => import("./views/ss/officer-approval-ss/component-rekap/OfficerRekapPage"))



// FA
const FaApprovalSsPage = lazy(() => import("./views/ss/fa-approval-ss/FaApprovalSsPage"))

// MSTD
const MstdApprovalSsPage = lazy(() => import("./views/ss/mstd-approval-ss/MstdApprovalSsPage"))
// const MstdListSs = lazy(() => import("./views/ss/mstd-approval-ss/component-list/MstdListSs"))
const MstdListSs = lazy(() => import("./views/ss/mstd-approval-ss/component-list/MstdListPage"))
const MstdDashboardSs = lazy(() => import("./views/ss/mstd-approval-ss/component/MstdDashboardSs"))
const MstdDashboardSsDept = lazy(() => import("./views/ss/mstd-approval-ss/component/MstdDashboardSsDept"))
const MstdRekapPage = lazy(() => import("./views/ss/mstd-approval-ss/component-rekap/MstdRekapPage"))




// SUPER ADMIN
const DepartemenPage = lazy(() => import("./views/admin/data-departemen/DepartemenPage"))
const KaryawanPage = lazy(() => import("./views/admin/data-karyawan/KaryawanPage"))

// My Profile
const MyProfile = lazy(() => import("./views/profile/EditProfile"))

// My Profile
const ContactUs = lazy(() => import("./views/contact-us/ContactUs"))


const DigimonPage = lazy(() => import("./views/test-page/DigimonPage"))
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute exact path="/analytics-dashboard" component={analyticsDashboard} />
          ...
          <AppRoute path="/digimon" component={DigimonPage} />

          <AppRoute path="/employees" component={EmployeesPage} />
          {/* <AppRoute path="/employees-add" component={DigimonPage} /> */}

          <AppRoute path="/home" component={HomePage} />

          {/* Operator */}
          <AppRoute path="/op-ss" component={OpSsPage} />

          {/* Spv */}
          <AppRoute path="/spv-approval-ss" component={SpvApprovalSsPage}/>
          <AppRoute path="/spv-rekap-ss" component={SpvRekapPage}/>
          <AppRoute path="/spv-list-ss" component={SpvListSs}/>



          {/* Officer */}
          <AppRoute path="/officer-approval-ss" component={OfficerApprovalSsPage}/>
          <AppRoute path="/officer-list-ss" component={OfficerListSs}/>
          <AppRoute path="/officer-dashboard-ss" component={OfficerDashboardSs}/>
          <AppRoute path="/officer-dashboard-ss-dept" component={OfficerDashboardSsDept}/>
          <AppRoute path="/officer-rekap-ss" component={OfficerRekapPage}/>


          {/* FA */}
          <AppRoute path="/fa-approval-ss" component={FaApprovalSsPage}/>

          {/* MSTD */}
          <AppRoute path="/mstd-approval-ss" component={MstdApprovalSsPage}/>
          <AppRoute path="/mstd-list-ss" component={MstdListSs}/>
          <AppRoute path="/mstd-dashboard-ss" component={MstdDashboardSs}/>
          <AppRoute path="/mstd-dashboard-ss-dept" component={MstdDashboardSsDept}/>
          <AppRoute path="/mstd-rekap-ss" component={MstdRekapPage}/>




          {/* Admin */}
          <AppRoute path="/departemen" component={DepartemenPage}/>
          <AppRoute path="/karyawan" component={KaryawanPage}/>

          <AppRoute path="/profile" component={MyProfile}/>
