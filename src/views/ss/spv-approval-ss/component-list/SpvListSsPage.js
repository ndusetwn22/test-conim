...
import SpvListSs from "./SpvListSs";
import SpvListSsView from "./SpvListSsView"


class SpvListPage extends React.Component {
  constructor(props){
      super(props);
      this.state = {
        addPage: false,
    ...
    return (
      <React.Fragment>
        ...
        <Row>
          <Col sm="12">
          {this.state.editPage ?
            <SpvListSsView {...this.state} {...this.props} changeViewPage={this.changeViewPage}/>
                :
            <SpvListSs {...this.state} {...this.props} changeViewPage={this.changeViewPage}/>
          }
